...
export default function TeamDashboard({
  ...
  useEffect(() => {
    ...
    guardarTemasProyectoDB(projectId, payload)
      ...
      .catch(() => undefined);
  }, [customCategories, projectId, themesHydrated]);
  ...
  useEffect(() => {
    if (!projectId || !teamSettingsHydrated) return;
  ...
  }, [positiveToneRules, constructiveToneRules, projectId, teamSettingsHydrated]);
